  ...
  return (
    <>
            ...
            <div className="flex flex-col justify-between w-full gap-2 py-3 mt-5 md:mt-0 md:justify-end sm:gap-5">
              ...
              <div className="grid w-full  max-w-sm items-center gap-1.5">
                ...
                <span className="text-xs font-light text-gray-400">
                  Selecciona la divisa en la que querés realizar el presupuesto
                </span>
                  ...
                  <div className="flex flex-col w-full max-w-full md:max-w-[400px] ">
                    <div className="flex flex-col w-full gap-2 h-fit">
                      ...
                      <span className="text-xs font-light text-gray-400">
                        ...
                        <b>pesos argentinos.</b> De ser el presupuesto hecho en
                        dólares, será convertido con la cotización ingresada
                      </span>
                    </div>
                    <Separator
                    ...
                    <div className="grid w-full max-w-sm items-center gap-1.5">
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          if (currency === "USD" && USDValue && transferFixed) {
        ...
        <Card className="w-full p-5 my-6 md:w-1/2">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-start justify-between w-full">
              <span className="text-sm font-semibold">Precio del vehículo</span>
              <span className="text-sm font-semibold">
                {intInVehicle?.currency} ${intInVehicle?.price.toLocaleString()}{" "}
              </span>
            </div>
            <span className="text-xs text-gray-400">{intInVehicle?.name}</span>
          </div>
          {/* precio del vehiculo */}
          {/* bonificaciones */}
          {intInVehicleBonifs.length > 0 && (
              ...
              <div className="flex flex-col mt-5">
                ...
                <div className="flex items-start justify-between w-full mt-2">
                  ...
                  <span className="text-sm font-semibold">
                    ...
                    {currency} $
                    {Number(intInVehicleBonifsSubtotal.toLocaleString()) < 0
                      ? Number(intInVehicleBonifsSubtotal.toLocaleString()) * -1
              ...
              <div className="py-7">
                <div className="w-full mb-3 h-fit">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-right">Detalles</FormLabel>
                        <FormControl>
                          <Input
                            type="text"
                            id="details"
      ...
      >
        <DialogContent className="sm:max-w-[425px]">
          <Form {...formCreate}>
            <form onSubmit={formCreate.handleSubmit(onSubmitLeadVehicBonif)}>
              <DialogHeader>
                <DialogTitle>Agregar bonificación</DialogTitle>
              </DialogHeader>
              <div className="py-7">
